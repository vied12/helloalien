...
(function() {
  ...
  window.serious.Widget = (function() {
    ...
    function Widget() {
      var _this = this;
      this.applyState = function(key) {
        return Widget.prototype.applyState.apply(_this, arguments);
      };
      this.setState = function(key, value) {
        return Widget.prototype.setState.apply(_this, arguments);
      };
      this.cloneTemplate = function(template_nui, dict, removeUnusedField) {
        if (removeUnusedField == null) {
          removeUnusedField = false;
        }
        return Widget.prototype.cloneTemplate.apply(_this, arguments);
      };
      this.show = function() {
        return Widget.prototype.show.apply(_this, arguments);
      };
      this.hide = function() {
        return Widget.prototype.hide.apply(_this, arguments);
      };
      this.set = function(field, value, context) {
        return Widget.prototype.set.apply(_this, arguments);
      };
    }
  ...
  window.serious.URL = (function() {
    ...
    function URL() {
      var _this = this;
      this.toString = function(hash_list) {
        if (hash_list == null) {
          hash_list = null;
        }
        return URL.prototype.toString.apply(_this, arguments);
      };
      this.fromString = function(value) {
        return URL.prototype.fromString.apply(_this, arguments);
      };
      this.enableDynamicLinks = function(context) {
        if (context == null) {
          context = null;
        }
        return URL.prototype.enableDynamicLinks.apply(_this, arguments);
      };
      this.updateUrl = function(hash) {
        if (hash == null) {
          hash = null;
        }
        return URL.prototype.updateUrl.apply(_this, arguments);
      };
      this.hasBeenAdded = function(key) {
        return URL.prototype.hasBeenAdded.apply(_this, arguments);
      };
      this.hasChanged = function(key) {
        return URL.prototype.hasChanged.apply(_this, arguments);
      };
      this.remove = function(key, silent) {
        if (silent == null) {
          silent = false;
        }
        return URL.prototype.remove.apply(_this, arguments);
      };
      this.update = function(fields, silent) {
        if (silent == null) {
          silent = false;
        }
        return URL.prototype.update.apply(_this, arguments);
      };
      this.set = function(fields, silent) {
        if (silent == null) {
          silent = false;
        }
        return URL.prototype.set.apply(_this, arguments);
      };
      this.onStateChanged = function(handler) {
        return URL.prototype.onStateChanged.apply(_this, arguments);
      };
      this.get = function(field) {
        if (field == null) {
          field = null;
        }
        return URL.prototype.get.apply(_this, arguments);
      };
      this.previousHash = [];
      this.handlers = [];
